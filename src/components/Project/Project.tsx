      ...
      <div className="projects">
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Speid System Sharif</h3>
              <p>
                Sepid System, a knowledge-based company with over a decade of
                experience, provides comprehensive identity verification
                solutions for access control and management across various
                corporate and organizational systems—such as digital
                authentication, time and attendance tracking, and access
                management for safe deposit boxes in banks and financial
                institutions—leveraging advanced biometric technologies
                including facial, fingerprint, and iris recognition, as well as
                smart cards.
              </p>
            </div>
            <footer>
